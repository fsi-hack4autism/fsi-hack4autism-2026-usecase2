...
## 5. Synthetic Data Agent

### Use Gemini on Vertex AI
Rather than using a separate synthetic data agent, leverage Gemini on Vertex AI to generate synthetic autism support case records. This ensures integration with the existing AI infrastructure.

### Custom Agent Purpose
The custom agent's job is to generate synthetic autism support case records using the following schema:
